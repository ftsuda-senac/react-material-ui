...
const AutocompleteWithInsert = () => {
  ...
  const sortedOptions = top100Films.map((option) => {
  ...
  return (
    <>
      ...
      <Dialog open={openInsertDialog} onClose={handleInsertClose} aria-labelledby="form-dialog-title">
